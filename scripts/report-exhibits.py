...
PHASE_NECESSARY = {
    ...
    "frame_init": "an allocator, not this O(n) link (bump/lazy next)",
    "task_init": "yes — U-mode task slots",
    "page_build": "yes — Sv39",
    "page_verify": "no — paranoia; kept as its own line (D-0043)",
    "activate": "yes — paging on",
    "virtq_init": "no — discarded first pass (finding 4); below 5% vs baseline",
    ...
    "accounting": "no — paranoia; subsumed by bump/lazy",
