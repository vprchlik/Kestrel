...
write_manifest_and_blocks() {
    ...
    local quiet='console=ttyS0 quiet loglevel=0 rdinit=/init unaligned_scalar_speed=fast'
    local instr='console=ttyS0 loglevel=7 printk.time=1 initcall_debug rdinit=/init unaligned_scalar_speed=fast'
    cat > "$MANIFEST" <<EOF
